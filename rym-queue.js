(() => {
  // 1) Paste the entire CSV between the backticks:
  const csvText = `Date,Name,Year,Letterboxd URI,Rating
2022-06-18,The Ballad of Narayama,1983,https://boxd.it/XI6,5
...PASTE THE REST...
`;

  if (!csvText || csvText.includes('...PASTE THE REST...')) {
    alert('Paste your CSV into csvText between the backticks, then run again.');
    return;
  }
